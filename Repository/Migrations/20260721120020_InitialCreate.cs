...
namespace Repository.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    {
                        table.PrimaryKey(
                            "PK_ECollectionEMovie",
                            x => new { x.CollectionsId, x.MoviesId }
                        );
                        table.ForeignKey(
        ...
        {
            migrationBuilder.DropTable(name: "CastCrewCredits");

            migrationBuilder.DropTable(name: "ECollectionEMovie");

            migrationBuilder.DropTable(name: "EGenreEMovie");
